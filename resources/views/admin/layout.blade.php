...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/home" class="logo">
      ...
      <img src="http://www.pollobrujo.com.co/wp-content/uploads/2017/02/logo-cabezote.png" width="30%">
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">App Pollo Brujo</li>
        ...
        <li><a href="{{url('order')}}"><i class="fa fa-tag"></i> <span>Ordenes</span></a></li>
        <li class="treeview">
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      Pollo Brujo Colombia
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">AIsoft</a>.</strong> All rights reserved.
  </footer>
